...
#SBATCH --mem=30G
#SBATCH --output=/scratch/prj/id_hill_sims_wellcda/CUTnTag/logs/Script2.4_MACS3_BRG1_%j.log
#SBATCH --error=/scratch/prj/id_hill_sims_wellcda/CUTnTag/logs/Script2.4_MACS3_BRG1_%j.log
