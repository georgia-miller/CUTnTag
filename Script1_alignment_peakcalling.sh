...
#SBATCH --mem=64G
#SBATCH --output=Script1_H3K4me1_%j.log
#SBATCH --error=Script1_H3K4me1_%j.log


#### MUST CHANGE: SCRIPT AND BASE NAME, DIRECTORY PATHS, MACS2 ARGS DEPENDENT ON TAG ####
# macs2 args for H3K4me1 (change for both single and merged): --broad --broad-cutoff 0.1
# might then need to change .narrowPeak to .broadPeak
